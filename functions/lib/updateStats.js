...
exports.manualUpdateStats = exports.onOrderWrite = exports.onProductWrite = exports.onUserWrite = void 0;
 ...
 */
exports.manualUpdateStats = functions
    .region('us-central1')
    .https.onCall(async (data, context) => {
    // Check if user is admin
    if (!context.auth || !context.auth.token.role || context.auth.token.role !== 'admin') {
        throw new functions.https.HttpsError('permission-denied', 'Only admins can manually update stats');
    }
